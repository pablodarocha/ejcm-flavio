            ...
            <div class="row no-padding">
                <div>
                    @foreach($diretoria as $diretor)
                        ...
                        @if($diretor->gender == 'M')
                            <?php $cargo = "Diretor" ?>
                        @elseif($diretor->gender == 'F')
                            <?php $cargo = "Diretora" ?>
                        @endif

                        @if($diretor->diretoria == 'gp')
                            <?php $ejcm = "$cargo de Gestão de Pessoas" ?>
                        @elseif($diretor->diretoria == 'ge')
                            <?php $ejcm = "Vice Presidente"; $cargo = "" ?>
                        @elseif($diretor->diretoria == 'proj')
                            <?php $ejcm = "$cargo de Projetos" ?>
                        @elseif($diretor->diretoria == 'mkt')
                            <?php $ejcm = "$cargo de Marketing" ?>
                        @elseif($diretor->diretoria == 'jufin')
                            @if($diretor->gender == 'M')
                                <?php $ejcm = "$cargo Juridico-Financeiro" ?>
                            @elseif($diretor->gender == 'F')
                                <?php $ejcm = "$cargo Juridico-Financeira" ?>
                            @endif
                        @elseif($diretor->diretoria == 'pres')
                            <?php $ejcm = "Presidente"; $cargo = "" ?>
                        @endif


                        <div class="tablet-padding col-xs-6 col-sm-2 center">
                            <img src="{{$diretor->photo}}" class="avatar-2 wow fadeInLeft small-show medium-show large-show" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <h4 class="equipe-diretoria section-title wow fadeInLeft small-show medium-show large-show" data-wow-duration="1000ms" data-wow-delay="600ms">{{$diretor->name}}</h4>
                            <h5 class="equipe-diretoria {{$diretor->diretoria}} section-title wow fadeInLeft small-show medium-show large-show" data-wow-duration="1000ms" data-wow-delay="600ms">{{$ejcm}}</h5>

                            <img src="{{$diretor->photo}}" class="avatar wow fadeInRight colapsed-show" data-wow-duration="1000ms" data-wow-delay="300ms">
                            <h4 class="equipe-diretoria section-title wow fadeInRight colapsed-show" data-wow-duration="1000ms" data-wow-delay="300ms">{{$diretor->name}}</h4>
                            <h5 class="equipe-diretoria {{$diretor->diretoria}} section-title wow fadeInRight colapsed-show" data-wow-duration="1000ms" data-wow-delay="300ms">{{$ejcm}}</h5>
                        </div>
                    @endforeach
                </div>
            </div>
